...
class IntroSVMTab(TabInterface):
    ...
    def render(self):
        with self.tab:
            ...
            st.image(
                "assets/imgs/svm.png",
                caption="Fonte: scikit-learn (https://scikit-learn.org/stable/modules/svm.html)",
            )
