        ...
        with self.tab:
            st.markdown(
                """
                    ...
                    Os programas da **:blue[Passos Mágicos]** variam desde oficinas culturais e projetos esportivos até eventos comunitários e ações de conscientização sobre direitos. A ONG também pode fornecer apoio psicológico, jurídico e social, visando a inclusão social e a melhoria da qualidade de vida dos atendidos. Para mais informações sobre os projetos específicos, parcerias ou como contribuir, é recomendável visitar o site oficial ou as redes sociais da **:blue[Passos Mágicos]**.<br/><br/>
                    Tendo sido fundada por **:blue[Michelle Flues]** e **:blue[Dimetri Ivanoff]** em **:blue[1992]**, tem **:blue[30]** anos de história transformando a vida de crianças e jovens de baixa renda em Embu-Guaçu. Inicialmente trabalhando em orfanatos, em **:blue[2016]** decidiram expandir o programa para alcançar mais jovens, oferecendo uma combinação de educação de qualidade, apoio psicológico, ampliação de visão de mundo e incentivo ao protagonismo, evoluindo para um projeto social e educacional abrangente.
                """,
            ...
            with st.container():
                ...
                st.markdown(
                    """A seguir, apresentamos alguns indicadores de impacto da ONG, conforme disponibilizados em seu site. Estes indicadores são comparativos aos de **:blue[2022]**, permitindo visualizar a evolução nos últimos dois anos."""
                )
                ...
                def calc_metrica_comparativa(indicador2022, indicador2023):
                    return format_number(
                        ((indicador2023 * 100) / indicador2022) - 100, "%0.2f"
                    )
