...
st.markdown(
    ...
    2. **:blue[Machine Learning e Redes Neurais:]** Desenvolveremos algoritmos de machine learning para classificar sentimentos nos reviews e comentários da página do Facebook. Estes modelos também serão treinados e validados com os feedbacks e anotações a respeito dos alunos, fornecidos dentro do dataset disponibilizado pela **:blue[Passos Mágicos]**. Utilizaremos redes neurais convolucionais (CNNs) para analisar sentimentos em imagens, identificando expressões faciais e contextos emocionais nas fotos. Os modelos serão treinados e validados para garantir precisão e eficácia.
    3. **:blue[Machine Learning e NLP:]** Aplicaremos técnicas de Processamento de Linguagem Natural (NLP) utilizando redes neurais recorrentes (RNNs) e transformers para analisar os sentimentos expressos em textos. Isso permitirá uma compreensão mais profunda das emoções e percepções dos beneficiários e da comunidade em relação às atividades da ONG.
