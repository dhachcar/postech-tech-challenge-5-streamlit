...
st.markdown(
    ...
    2. **:blue[Machine Learning e Redes Neurais:]** Desenvolveremos algoritmos de machine learning para classificar sentimentos nos reviews e comentários da página do Facebook. Estes modelos também serão treinados e validados com os feedbacks e anotações a respeito dos alunos, fornecidos dentro do dataset disponibilizado pela **:blue[Passos Mágicos]**. Utilizaremos redes neurais convolucionais **:blue[(CNNs)]** para analisar sentimentos em imagens, identificando expressões faciais e contextos emocionais nas fotos. Além disso, também serão utilizadas redes do tipo Perceptron Multilayer (MLP) para realizar alguns tipos de previsão. Além das redes neurais, também serão aplicados alguns modelos durante este projeto, em especial o SVC e o XGB.
    ...
    4. **:blue[Conclusão:]** Os resultados das análises serão integrados em um sistema prático e eficiente, com ferramentas de visualização de dados que apresentem os insights de forma clara e impactante. Este sistema ajudará a ONG **:blue[Passos Mágicos]** a tomar decisões informadas, melhorar suas estratégias e comunicar seu impacto de maneira eficaz.
""",
    unsafe_allow_html=True,
)
